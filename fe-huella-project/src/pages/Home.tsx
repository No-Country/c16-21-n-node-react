        ...
        <section className=" flex flex-col justify-center mt-20  mb-[5rem]">
         ...
         <div className=" mb-[5rem] flex justify-around w-[100%]  ">
            ...
            <div className=" overflow-hidden shadow-2xl w-[25rem] rounded-3xl h-[25rem] m-[2rem]">
              <img className="h-[22rem] object-cover overflow-hidden " src={doberman} alt="" />
          ...
          <button className="  align-center m-auto inline-block  text-center  w-[25%] rounded-full h-10    shadow-md shadow-gray-400   text-sm px-4 py-3 leading-none text-white bg-blue-buttons  hover:border-transparent hover:shadow-none hover:text-blue-buttons hover:bg-white  lg:mt-0">encontre una mascota perdida</button>


          <div>
            <h1 className=" m-10 text-center font-bold text-4xl">mis mascotas</h1>
