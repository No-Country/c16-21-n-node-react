      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "15px", marginTop: "50px" }}>
            ...
            <input type="profilePic" placeholder="imagen de perfil"  {...register("profilePic", { required: true })} className="w-500 h-250 p-15 pl-24 pr-302 rounded-12 border border-gray-400" />
